        ...
        <Container>
          <Grid item xs={12}>
            ...
            >
                ...
                <Box>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      color="primary.contrastText"
                    >
                      956-249-0167 (for franchise info only)
                    </Typography>
                  </Link>
                </Box>
              </Grid>

              {/* Find us on - Sushi Rollin’ Garland */}
                ...
                <Box sx={{ mb: 2, mt: 1 }}>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      color="primary.contrastText"
                    >
                      (469) 798 - 7831 (for online orders)
                    </Typography>
                  </Link>
                </Box>
              ...
              {/* Find us on - Sushi Rollin’ Lewisville */}

                <Typography
                  variant={isMobile ? "body2" : "h5"}
                  color="secondary.main"
                >
                  SushiRollin’ Lewisville
                </Typography>
                ...
                <Box sx={{ mb: 1, mt: 1 }}>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      color="primary.contrastText"
                    >
                      (817) 320 - 3722 (for online orders)
                    </Typography>
                  </Link>
                </Box>
              </Grid>
